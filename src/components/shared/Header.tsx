...
<<<<<<< HEAD
      className="bg-white rounded-2xl border border-slate-200/80 p-4 shadow-[0_4px_25px_-5px_rgba(0,0,0,0.02)] flex justify-between items-center relative z-20 gap-2"
    >
      ...
      <div className="flex items-center gap-2.5 min-w-0">
        <motion.div 
          ...
          className="w-10 h-10 shrink-0 bg-gradient-to-tr from-blue-600 via-indigo-600 to-indigo-700 rounded-xl flex items-center justify-center text-white font-bold shadow-md shadow-indigo-100"
        >
          <ShieldCheck className="w-5 h-5 text-white" />
        </motion.div>
        <div className="min-w-0">
          <h1 className="text-sm font-black text-slate-900 tracking-tight leading-tight bg-gradient-to-r from-slate-900 to-indigo-950 bg-clip-text text-transparent truncate">Private Academy Portal</h1>
          <p className="text-[10px] text-slate-400 font-extrabold uppercase tracking-wider font-mono truncate">Academic Session 2026</p>
=======
...
<<<<<<< HEAD
      <div className="flex items-center gap-3 shrink-0">
        ...
        <span className="hidden sm:inline-flex items-center gap-1.5 text-[10px] bg-emerald-50 text-emerald-700 font-extrabold px-3 py-1.5 rounded-xl border border-emerald-100/60 shadow-2xs">
          <span className="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse shadow-[0_0_6px_rgba(16,185,129,0.5)]" /> Portal Operational
=======
...
<<<<<<< HEAD
              className="absolute right-0 mt-3.5 w-72 sm:w-80 bg-white border border-slate-200/85 rounded-2xl shadow-[0_20px_50px_-12px_rgba(0,0,0,0.1)] p-4 space-y-3 z-50 text-left"
=======
...
<<<<<<< HEAD
                        <span className="text-xs font-bold text-slate-800 leading-tight pr-2">{notif.title}</span>
                        {!notif.read && <span className="w-1.5 h-1.5 shrink-0 rounded-full bg-red-500 mt-1" />}
=======
...
<<<<<<< HEAD
            className="p-2.5 bg-blue-50 hover:bg-blue-100 hover:text-blue-800 text-blue-600 rounded-xl transition border border-blue-250 border-blue-200 cursor-pointer flex items-center justify-center shrink-0"
=======
